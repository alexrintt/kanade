...
class Stepper extends StatefulWidget {
  ...
  final Widget? Function(BuildContext, int, StepState)? stepIconBuilder;
  final Color? dividerColor;
  final Color? indexedTextColor;
...
class _StepperState extends State<Stepper> with TickerProviderStateMixin {
  ...
  Widget _buildLine(bool visible) {
    return Container(
      ...
      height: 16.0,
      color: widget.dividerColor ?? Colors.grey.shade400,
    );
  }
  ...
  Widget _buildCircleChild(int index, bool oldState) {
    ...
    if (widget.stepIconBuilder != null) {
      final Widget? child = widget.stepIconBuilder!(context, index, state);
      ...
      case StepState.disabled:
        return Text(
          ...
          style: isDarkActive
              ...
              : widget.indexedTextColor != null
                  ? _kStepStyle.copyWith(
                      color: widget.indexedTextColor,
                    )
                  : _kStepStyle,
        );
      ...
      case StepState.error:
        return Text(
          ...
          style: isDarkActive
              ...
              : widget.indexedTextColor != null
                  ? _kStepStyle.copyWith(color: widget.indexedTextColor)
                  : _kStepStyle,
        );
    }
  }
  ...
  TextStyle _titleStyle(int index) {
    ...
    final StepState state = widget.steps[index].state;
